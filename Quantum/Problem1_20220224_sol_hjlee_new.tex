...
\begin{itemize}
  ...
  \begin{align}
    ...
    \frac{\partial}{\partial p_x}\left(e^{-i\frac{p^2}{2m\hbar}t}\phi(p,0) \right)\,d^3p  \\
    &=i\hbar\int e^{i\frac{p^2}{2m\hbar}t}\phi^*(p,0)
  ...
  and $\langle p_x \rangle^2=\langle p_x \rangle^2_{t=0}$ because of a (31).
  \begin{align}
...
\end{align}
  ...
  \begin{align}
    \begin{split}  
      ...
      \frac{\partial^2}{\partial p_x^2}\left(e^{-i\frac{p^2}{2m\hbar}t}\phi(p,0)\right)\,d^3p  \\
      =& -\hbar^2\int e^{i\frac{p^2}{2m\hbar}t}\phi^*(p,0)
      \frac{\partial}{\partial p_x}\left(-i\frac{p_x}{m\hbar}te^{-i\frac{p^2}{2m\hbar}t}\phi(p,0)
...
첫번째 적분 항을 먼저 계산해보자. $i\hbar$ 는 momentum space 에서도 canonical commute relation 으로 생각할 수 있다.
  ...
  \end{align}
두번째 적분 항은 다음과 같다. 
$x$ 는 momentum space 에서 연산자 $i\hbar\frac{\partial}{\partial p_x}$ 로 작용한다는 사실에 유의하자.
  \begin{align}
    \begin{split}

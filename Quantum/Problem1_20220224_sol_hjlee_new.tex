...
Finally we obtain the normalization constant,
  ...
  \begin{align}
    ...
    \exp\left( -\frac{2m\sigma^2+i\hbar t}{2m\hbar^2} p^2 -\frac{2\sigma^2p_0-i\hbar x_0}{\hbar^2}  p-\frac{\left(\sigma^2p_0+i\hbar x_0\right)p_0}{\hbar^2} \right) \\
    &= {\left(\frac{2\sigma^2}{\pi\hbar^2}\right)}^{\frac{1}{4}}
    \exp\left( -\frac{2m\sigma^2+i\hbar t}{2m\hbar^2}{\left( p + \frac{2m\sigma^2p_0-im\hbar x_0}{2m\sigma^2+i\hbar t} \right)}^2 +\frac{(2m\sigma^2p_0-im\hbar x_0)^2}{4m^2\hbar^2\sigma^2+2im\hbar^3 t}  -\frac{\left(\sigma^2p_0+i\hbar x_0\right)p_0}{\hbar^2} \right)
  \end{align}
  \item[(4)] 
  \item[(5)] 
  \end{itemize}

...
%\begin{align}
%         N^2\int\exp\left(-2{\left(\frac{x-x_0}{2\sigma}\right)}^2\right) \,dx =N^2\int\exp\left({-2\left(\frac{x}{2\sigma}\right)}^2\right) \,dx
%\end{align} 
To make a convenient form, change a integral variable.
\begin{align}
          N^2\int\exp\left(-2{\left(\frac{x-x_0}{2\sigma}\right)}^2\right) \,dx
          %N^2\int\exp\left(-2{\left(\frac{x}{2\sigma}\right)}^2\right) \,dx =N^2\int\exp\left({-2\left(\frac{x}{2\sigma}\right)}^2\right) \,dx 
...
It is in the sense.
  ...
  \\                     &= = \frac{1}{2}\left[ |\psi_1(\bm{x})|^2 + |\psi_2(\bm{x})|^2 + \left(\psi_1^*\psi_2 + {\left(\psi_1^*\psi_2\right)}^*\right)\cos{\omega t} \right]
      \end{align*}
    \item[(d)]   
